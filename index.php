...
<div class="mdui-drawer" id="drawer">
    <ul class="mdui-list">
        ...
        <li class="mdui-list-item mdui-ripple">
            <div class="mdui-list-item-content">Account</div>
        </li>
        <li class="mdui-list-item mdui-ripple">
            <div class="mdui-list-item-content">LearningXXX</div>
        </li>
        <li class="mdui-list-item mdui-ripple">
            <div class="mdui-list-item-content">My Word List</div>
        </li>
        <li class="mdui-list-item mdui-ripple">
            <div class="mdui-list-item-content">Contact</div>
        </li>
    </ul>
</div>

<nav class="uk-navbar">
    <div class="mdui-container" style="position: relative;left: 500px;">
